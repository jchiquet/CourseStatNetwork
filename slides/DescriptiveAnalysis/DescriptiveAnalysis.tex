...
\begin{frame}
  ...
  \begin{definition}[Ajacency matrix]
...
\hlstd{faction} \hlkwb{<-} \hlkwd{get.vertex.attribute}\hlstd{(karate,} \hlstr{"Faction"}\hlstd{)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in get.vertex.attribute(karate, "{}Faction"{}): get.vertex.attribute requires an argument of class network.}}\begin{alltt}
\hlstd{f.colors} \hlkwb{<-} \hlkwd{as.character}\hlstd{(}\hlkwd{length}\hlstd{(faction))}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'faction' not found}}\begin{alltt}
\hlstd{f.colors[faction} \hlopt{==} \hlnum{1}\hlstd{]} \hlkwb{<-} \hlstr{"red"}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in f.colors[faction == 1] <- "{}red"{}: object 'f.colors' not found}}\begin{alltt}
\hlstd{f.colors[faction} \hlopt{==} \hlnum{2}\hlstd{]} \hlkwb{<-} \hlstr{"cyan"}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in f.colors[faction == 2] <- "{}cyan"{}: object 'f.colors' not found}}\begin{alltt}
\hlkwd{par}\hlstd{(}\hlkwc{mfrow}\hlstd{=}\hlkwd{c}\hlstd{(}\hlnum{1}\hlstd{,}\hlnum{2}\hlstd{))}
