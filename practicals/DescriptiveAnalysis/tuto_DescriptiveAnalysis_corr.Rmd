...
Looking at the eigen values of the Laplacian, we see that the smallest one is beyond the numerical precision, thus practically zero (meaning one connected component)
. The second smallest eigen value is extremely small two: indeed, the community graph that we generated is extremely close to a two-component graph.
